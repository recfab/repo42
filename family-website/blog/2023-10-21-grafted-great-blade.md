...
---
# Grafted Great Blade from Elden Ring

I summoned Castellan Edgar to fight the Leonine Misbegotten. It dropped the [Grafted Blade Greatsword](https://eldenring.wiki.fextralife.com/Grafted+Blade+Greatsword).
...
> **Mino:** "It looks like a tetanus Christmas tree" #ShitMinoSays
...
> Swear an oath upon the greatsword to avenge the clan, temporarily raising all attributes for a certain duration. While the oath's affects are active, poise will also be increased. 

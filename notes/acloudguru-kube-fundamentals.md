...
There is a nice diagram on https://kubernetes.io/docs/concepts/overview/components/[this page]

"Master node" - usually a separate physical or virtual machine.
manager for entire cluster.
...
collection of nodes (hosts), storage and network each cluster has at least one Master
...
Install Hyperkit with Brew.
Hyperkit is the new hotness, I guess.
VirtualBox is old and busted
 ...
 ** "Ensure that this group of 5 web servers and 2 database servers are running at all times with X exposed ports and these resource allocations.
If they aren't, restart them"

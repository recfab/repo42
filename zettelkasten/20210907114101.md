...
- "Smart endpoints and dumb pipes"
  - a *reliable* distributed monolith is still a distributed monolith
...
- **Conversations / sagas**
  - e.g. multiple steps to make a booking and each step can add data to the message, process credit card payments, etc.
...
- `If-modified-since`, `etag`, etc. to control caching
...
- *Hybrid* approach - most real systems have a mix of requests and events
